...
module.exports = {
  ...
  methods: {
    ...
    showContextMenu(key, event) {
      ...
      this.hideAllMenus()
      this.locateAtMouseEvent(event, style)
...
module.exports.render = function() {
  with(this){return _c('div',{staticClass:"ob-menu-manager",class:{ 'underline-mnemonic': underlineMnemonic }},_l((menu),function(item,index){return _c('menu-view',{key:index,ref:"menus",refInFor:true,attrs:{"menu":item.children,"context":item.context}})}))}
};
